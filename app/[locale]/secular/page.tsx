...
export default async function SecularPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div dir={t.direction} className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-violet-50 text-stone-900">
