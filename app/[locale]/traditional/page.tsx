...
export default async function TraditionalPage({
  ...
  return (
    <div
      dir={t.direction}
      className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-rose-50 text-stone-900"
    >
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {page.highlights.map((item: string) => (
            <div
              key={item}
              className="rounded-2xl bg-white/80 p-5 shadow-sm ring-1 ring-white/70"
            >
